...
@section('title', 'Watch Movies')
@section('title-description', 'Our movies is selected for your best experience')
        ...
        <div class="grid grid-cols-2 gap-5 xl:gap-12">
            @foreach ($movies as $movie)
                <div class="col-span-1 relative overflow-hidden group">
                    <img src="/storage/thumbnail/{{ $movie->large_thumbnail }}" class="object-cover rounded-[30px]" alt="">
                    <div
                        ...
                        <div class="px-7 pb-7">
                            ...
                            <p class="mb-0 text-stream-gray text-base mt-[10px]">{{ date('Y' ,strtotime($movie->created_at)) }}</p>
                        </div>
                    </div>
